    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event){
                ...
                if($('#action').val() == "Add"){
                    ...
                    $.ajax({
                        url:"http://localhost/DB_DOSEN/api/employee/create.php",
                        method:"POST",
                    ...
                    $.ajax({
                        url:"http://localhost/DB_DOSEN/api/employee/update.php",
                        method:"PUT",
                        data: JSON.stringify(formData),
                        success:function(data){
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                    ...
                    url: "http://localhost/DB_DOSEN/api/employee/read.php",
                    success: function(response) { 
                        ...
                        for (var i = 0; i < json.length; i++) {
                            var sub_array = {
                                'nama' : json[i].nama,
                                'email' : json[i].email,
                                'mata_kuliah' : json[i].mata_kuliah,
                                'usia' : json[i].usia,
        ...
        function showOne(id) {
            ...
            $.ajax({
                    type: "GET",
                    contentType: "application/json",
                    url: "http://localhost/DB_DOSEN/api/employee/read.php?id="+id,
                    success: function(response) { 
                        $('#id').val(response.id);
                        $('#nama').val(response.nama);
                        $('#email').val(response.email);
                        $('#mata_kuliah').val(response.mata_kuliah);
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url:"http://localhost/DB_DOSEN/api/employee/delete.php",
                method:"DELETE",
